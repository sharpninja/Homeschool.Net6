...
public partial class WrapPanel : Panel
{
    ...
    {
        get => (double)GetValue(WrapPanel._itemHeightProperty);
        set => SetValue(WrapPanel._itemHeightProperty, value);
    }
    ...
    /// dependency property
    /// </value>
    public static readonly DependencyProperty _itemHeightProperty =
        DependencyProperty.Register(
            "_itemHeight",
            typeof(double),
            typeof(WrapPanel),
            new PropertyMetadata(double.NaN, WrapPanel.OnItemHeightOrWidthPropertyChanged));
    ...
    /// </value>
    //[TypeConverter(typeof(LengthConverter))]
    public double _itemWidth
    {
        get => (double)GetValue(WrapPanel._itemWidthProperty);
        set => SetValue(WrapPanel._itemWidthProperty, value);
    }
    ...
    /// dependency property.
    /// </value>
    public static readonly DependencyProperty _itemWidthProperty =
        DependencyProperty.Register(
            "_itemWidth",
            typeof(double),
            typeof(WrapPanel),
    ...
    {
        get => (Orientation)GetValue(WrapPanel._orientationProperty);
        set => SetValue(WrapPanel._orientationProperty, value);
    }
    ...
    /// dependency property.
    /// </value>
    public static readonly DependencyProperty _orientationProperty =
        DependencyProperty.Register(
            "_orientation",
            typeof(Orientation),
            typeof(WrapPanel),
            new PropertyMetadata(Orientation.Horizontal, WrapPanel.OnOrientationPropertyChanged));
    ...
    private static void OnOrientationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
            ...
            (value != Orientation.Vertical))
        {
            ...
            source.SetValue(WrapPanel._orientationProperty, (Orientation)e.OldValue);
    ...
    protected override Size MeasureOverride(Size constraint)
    {
        ...
        return new(totalSize.Width, totalSize.Height);
    }
    ...
    private void ArrangeLine(int lineStart, int lineEnd, double? directDelta, double indirectOffset, double indirectGrowth)
    {
        ...
        for (int index = lineStart; index < lineEnd; index++)
        {
            ...
            Rect bounds = isHorizontal ?
                new(directOffset, indirectOffset, directGrowth, indirectGrowth) :
...
internal static class NumericExtensions
{
    ...
    public static bool IsGreaterThan(double left, double right)
        => (left > right) && !NumericExtensions.AreClose(left, right);
