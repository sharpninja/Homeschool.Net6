...
class ActivityFeedLayout : VirtualizingLayout
{
    ...
    {
        get => _rowSpacing;
        set => SetValue(ActivityFeedLayout._rowSpacingProperty, value);
    }

    public static readonly DependencyProperty _rowSpacingProperty =
        DependencyProperty.Register(
            "_rowSpacing",
            typeof(double),
            typeof(ActivityFeedLayout),
            new PropertyMetadata(0, ActivityFeedLayout.OnPropertyChanged));
    ...
    {
        get => _colSpacing;
        set => SetValue(ActivityFeedLayout._columnSpacingProperty, value);
    }

    public static readonly DependencyProperty _columnSpacingProperty =
        DependencyProperty.Register(
            "_columnSpacing",
            typeof(double),
            typeof(ActivityFeedLayout),
    ...
    {
        get => _minItemSize;
        set => SetValue(ActivityFeedLayout._minItemSizeProperty, value);
    }

    public static readonly DependencyProperty _minItemSizeProperty =
        DependencyProperty.Register(
            "_minItemSize",
            typeof(Size),
            typeof(ActivityFeedLayout),
            new PropertyMetadata(Size.Empty, ActivityFeedLayout.OnPropertyChanged));

    private static void OnPropertyChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
    {
        ActivityFeedLayout layout = obj as ActivityFeedLayout;
        if (args.Property == ActivityFeedLayout._rowSpacingProperty)
        {
            layout._rowSpacing = (double)args.NewValue;
        }
        else if (args.Property == ActivityFeedLayout._columnSpacingProperty)
        {
            layout._colSpacing = (double)args.NewValue;
        }
        else if (args.Property == ActivityFeedLayout._minItemSizeProperty)
        {
    ...
    protected override Size MeasureOverride(VirtualizingLayoutContext context, Size availableSize)
    {
        ...
        for (int rowIndex = firstRowIndex; rowIndex < lastRowIndex; rowIndex++)
        {
            ...
            Rect[] boundsForCurrentRow = CalculateLayoutBoundsForRow(rowIndex, desiredItemWidth);

            for (int columnIndex = 0; columnIndex < 3; columnIndex++)
            {
                int index = firstItemIndex + columnIndex;
                Rect rect = boundsForCurrentRow[index % 3];
                UIElement container = context.GetOrCreateElementAt(index);
        ...
        double extentHeight = ((int)(context.ItemCount / 3) - 1) * (MinItemSize.Height + RowSpacing) + MinItemSize.Height;

        // Report this as the desired size for the layout
        return new(desiredItemWidth * 4 + ColumnSpacing * 2, extentHeight);
    }
    ...
    protected override Size ArrangeOverride(VirtualizingLayoutContext context, Size finalSize)
    {
        ...
        foreach (Rect arrangeRect in state.LayoutRects)
        {
            UIElement container = virtualContext.GetOrCreateElementAt(currentIndex);
    ...
    private Rect[] CalculateLayoutBoundsForRow(int rowIndex, double desiredItemWidth)
    {
        ...
        double yoffset = rowIndex * (MinItemSize.Height + RowSpacing);
