...
public partial class ItemPage : Page
{
...
#if ANDROID
        bool isEnabled =
            LayoutVisualStates.CurrentState == LargeLayout;
    ...
    {
        ElementTheme currentElementTheme = ((_currentElementTheme != null
            ? _currentElementTheme.Value
            : ElementTheme.Default) == ElementTheme.Default) ? ThemeHelper.ActualTheme : _currentElementTheme.Value;
    ...
    private void OnRelatedControlClick(object sender, RoutedEventArgs e)
    {
        ...
        Frame.Navigate(typeof(ItemPage), b.DataContext.ToString());
    }

    protected override async void OnNavigatedTo(NavigationEventArgs e)
    {
        ControlInfoDataItem item = await ControlInfoDataSource.Instance.GetItemAsync((string)e.Parameter).ConfigureAwait(false);
