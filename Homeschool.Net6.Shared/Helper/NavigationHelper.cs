...
public partial class NavigationHelper : DependencyObject
{
    ...
    public void OnNavigatedTo(NavigationEventArgs e)
    {
        ...
        if (e.NavigationMode == NavigationMode.New)
        {
            ...
            LoadState?.Invoke(this, new(e.Parameter, null));
        }
        else
        {
            ...
            // from cache
            LoadState?.Invoke(this, new(e.Parameter, (Dictionary<string, object>)frameState[_pageKey]));
        }
    }
    ...
    public void OnNavigatedFrom(NavigationEventArgs e)
    {
        ...
        SaveState?.Invoke(this, new(pageState));
...
public class RootFrameNavigationHelper
{
    ...
    SystemNavigationManager _systemNavigationManager;
    ...
    private bool TryGoBack()
    {
        ...
        if (CurrentNavView.IsPaneOpen && (CurrentNavView.DisplayMode == Microsoft.UI.Xaml.Controls.NavigationViewDisplayMode.Compact || CurrentNavView.DisplayMode == Microsoft.UI.Xaml.Controls.NavigationViewDisplayMode.Minimal))
        {
            return false;
        }
